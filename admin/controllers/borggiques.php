...
class BorggiqueControllerBorggiquess extends JControllerAdmin
{
	public function getModel($name = 'Borggique', $prefix = 'BorggiqueModel', $config = array('ignore_request' => true))
	{
