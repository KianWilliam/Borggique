...
<form action="<?php echo JRoute::_('index.php?option=com_borggique&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="borggique-form" class="form-validate">
               <div class="width-60 fltlft">
				    <fieldset class="adminform">
						<legend><?php echo empty($this->item->id) ? JText::_('COM_BORGGIQUE_NEW') : JText::sprintf('COM_BORGGIQUE_BORGGIQUE_SETTINGS', $this->item->id); ?></legend>
